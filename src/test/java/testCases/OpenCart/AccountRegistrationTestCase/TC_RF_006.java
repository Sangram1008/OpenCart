...
public class TC_RF_006 extends BaseClass {
    ...
    @Test
    public void validateRegisteringAccountWhen_No_optionSelectedOnNewsletter() {
        ...
        try {
            ...
            nlp.clickNoNewsletter();

            waitElement(nlp.reg_NoNewsletter, 50, "visibility");
            ...
            Assert.assertTrue(nlp.checkNoNewsletterSubscription(), "No Newsletter Subscription is Not Selected By Default");
